...
export const inputPainel =
  "w-full rounded-xl border border-fl-border bg-fl-page px-4 py-3 text-sm text-fl-ink placeholder-finlow-muted outline-none focus:border-fl-500 transition-colors"
