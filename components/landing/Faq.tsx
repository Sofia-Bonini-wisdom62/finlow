...
const faqs = [
  ...
  { q: "Vai ter custo?", a: "Criar conta e usar o Finlow é grátis, com um limite mensal de uso da inteligência artificial. Para quem quiser um limite bem maior existe um plano premium opcional: nada é cobrado sem você escolher e confirmar. Quem chega agora, no começo, terá condições especiais." },
]
