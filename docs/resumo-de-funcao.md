...
| 13 | Curso escolar v2 "substitui a trilha escolar atual" | `docs/arquitetura-pedagogica.md` §9, `docs/backlog-curso-v2.md` | Conteúdo (24/08) e player (30/08, `components/curso/`, `/curso/[slug]`) prontos e verificados sem banco — **mas o seed nunca rodou em produção** e a fusão com a trilha (corredor, XP, progresso) é fila própria. Até lá, quem abre a Trilha continua vendo os 107 módulos escolares antigos; `/curso/<slug>` responde 404 enquanto `LicaoCurso` estiver vazia. |
